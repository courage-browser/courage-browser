...
const Config = function () {
  ...
  this.braveCoreDir = path.join(this.rootDir, getNPMConfig(['projects', 'courage-core', 'dir']))
  this.braveCoreRepo = getNPMConfig(['projects', 'courage-core', 'repository', 'url'])
...
Config.prototype.buildArgs = function () {
  ...
  let args = {
    ...
    brave_product_name: getNPMConfig(['brave_product_name']) || "courage-core",
    brave_project_name: getNPMConfig(['brave_project_name']) || "courage-core",
...
Config.prototype.buildProjects = function () {
  ...
  // we only have two now (chrome and courage-core) and anything else will be
  // managed by deps
